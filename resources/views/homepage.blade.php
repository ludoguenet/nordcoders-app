    ...
    <div class="relative px-6 lg:px-8">
        <div class="mx-auto max-w-3xl py-24 lg:py-40">
            <div class="text-center">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-6xl"> Apprenez à développer <br>avec <span class="whitespace-nowrap text-transparent bg-clip-text bg-gradient-to-br from-emerald-100 to-emerald-500 dark:from-sky-100 dark:to-sky-500"> &lt;?nordcoders </span>
                </h1>
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="https://www.youtube.com/NordCoders" class="rounded-md bg-emerald-600 dark:bg-sky-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500 dark:hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600" target="_blank"> Découvrir la chaîne YouTube </a>
        ...
        <div class="bg-white dark:bg-gray-700 py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:text-center">
                    <h2 class="text-base font-semibold leading-7 text-emerald-600 dark:text-sky-600"> Nord Coders, c'est quoi? </h2>
                    ...
                    <dl class="grid max-w-xl grid-cols-1 gap-y-10 gap-x-8 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                        <div class="relative pl-16">
                            <dt class="text-base font-semibold leading-7 text-gray-900 dark:text-gray-100">
                                <div class="absolute top-0 left-0 flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-600 dark:bg-sky-600">
